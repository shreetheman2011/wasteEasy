...
export default function RewardsPage() {
      ...
      try {
        ...
        if (userEmail) {
          ...
          if (fetchedUser) {
            ...
            toast.error(
              "User not found. Please log in again or try to reload."
            );
          }
        } else {
          toast.error("User not found. Please log in again or try to reload.");
        }
      } catch (e) {
  ...
  return (
    <div className="px-4 py-6 sm:p-8 max-w-4xl mx-auto">
      ...
      <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg flex flex-col justify-between h-full border-l-4 border-green-500 mb-8">
