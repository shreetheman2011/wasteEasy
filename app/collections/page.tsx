    ...
    try {
      ...
      try {
        ...
        if (parsedResult.wasteTypeMatch && parsedResult.confidence > 0.7) {
          ...
          const earnedReward = 20; // Random reward between 10 and 59
          ...
          await createNotification(
            user.id,
            `You've earned 20 points for collecting waste!`,
            "Reward Earned!"
          );
          ...
          toast.error(
            "Verification failed. The collected waste does not match the reported waste. If you think this is an error, please contact your organization leader.",
            {
              duration: 5000,
              position: "top-center",
            }
